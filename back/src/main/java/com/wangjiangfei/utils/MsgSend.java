...
public class MsgSend {
    ...
    private static final String appKey = "23747225";
    private static final String appSecret = "c341c043643225b9bb2927e57cf885c8";

    private static String phone0;
    private static String code0;

    public static void main(String[] args) throws Exception {
        System.out.println(send("18832019843", "888"));
    }

    public static String send(String phone, String code) throws Exception {
        if (phone.equals("") || code.equals("")) {
            throw new Exception("phone和code不能为空");
        }
        phone0 = phone;
        code0 = code;

        return getSellerItem();
    }
    /*{"alibaba_aliqin_fc_sms_num_send_response":{"result":{"err_code":"0","model":"106907263843^1109334668462","success":true},"request_id":"44nrp3ihhfiw"}}*/
    ...
    private static String getSellerItem() throws IOException {
        ...
        params.put("rec_num", phone0);
        params.put("sms_template_code", "SMS_61090154");
        params.put("sms_param", "{\"code\":\"" + code0 + "\"}");
        params.put("sms_free_sign_name", "北冥有鱼");
